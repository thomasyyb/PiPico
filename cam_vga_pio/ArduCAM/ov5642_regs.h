...
const struct sensor_reg OV5642_320x240_RAW[]  =
{
	/*
{0x3800,0x03},
{0x3801,0xE8},
...
// trying
const struct sensor_reg OV5642_320x240_RGB565[]  =
{
	// 320
	{0x3808,0x01},
	{0x3809,0x40},
	...
	{0x380A,0x00},
	{0x380B,0xf0},
	// {0x4300,0x60},  // RGB565, BGR
	// {0x4300,0x61},  // RGB565, RGB
	// {0x4300,0xF8},  // RAW
	...
	// {0x4740,0x21},	// polarity control
	{0x501e,0x2a},  // RGB dither control
	{0x5002,0xf8},  // ISP control: YUV to RGB enable
	{0x501f,0x01},  // Format Mux Control: ISP RGB
	{0x4300,0x61},  // RGB565, RGB
	{0xffff,0xff},
};

// size a little bigger than 640x480, needs debugging
const struct sensor_reg OV5642_640x480_RGB565[]  =
{
	// 640
	{0x3808,0x02},
	{0x3809,0x80},
...
{
	{0x3103 ,0x93},	// PLL CLK select
	{0x3008 ,0x82},	// reset
	{0x3017 ,0x7f}, // pad output enable 1
	{0x3018 ,0xfc}, // pad output enable 2
	{0x3810 ,0xc2}, // Horizontal and Vertical Offset Setting
	{0x3615 ,0xf0}, // analog register
	{0x3000 ,0x00}, // Reset for Individual Block
	{0x3001 ,0x00}, // Reset for Individual Block
	{0x3002 ,0x5c}, // Reset for Individual Block
	{0x3003 ,0x00}, // Reset for Individual Block
	{0x3004 ,0xff}, // Clock Enable Control
	{0x3005 ,0xff}, // Clock Enable Control
	{0x3006 ,0x43}, // Clock Enable Control
	{0x3007 ,0x37}, // Clock Enable Control
	{0x3011 ,0x08}, // PLL control
	{0x3010 ,0x10},
	{0x460c ,0x22},
	{0x3815 ,0x04},
	{0x370c ,0xa0},
...
// OV5642 software application notes P63
const struct sensor_reg OV5642_QSXGA_to_VGA_640x480[]  =
{
	{0x3800, 0x1 },
	{0x3801, 0x8A},
	{0x3802, 0x0 },
